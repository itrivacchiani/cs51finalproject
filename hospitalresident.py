...
if (problem != "stable marriage" and problem != "hospital resident"):
  if problem = "stable roommates" or problem = "stable roommate"
    print("Your preferences csv file indicates stable roommates as the problem rather than hospital resident or stable marriage. Make a new selection.")
  else:
    print("Your preferences csv file does not indicate a possible problem.")
    print("Please change the problem name in your csv file to stable marriage, hospital resident, or stable roommate. Then make the appropriate problem choice.")
  raise ValueError('CSV file does not match problem to solve.')
